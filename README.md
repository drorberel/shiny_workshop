...
This session is designed for practitioners who want to move past theory
and into implementation. We’ve scrapped the slide deck in favor of a
**live, documentation-driven workflow** that mirrors how real-world
development actually happens.

### **1. Tool Evaluation & Selection**

Instead of a “one size fits all” tutorial, you will identify a specific
feature needed for your current project.

- **Compare & Contrast:** We will demonstrate how to evaluate different
  Shiny extensions and packages that solve similar problems.

- **Strategic Selection:** Learn the criteria for choosing a tool -
  community support, ease of integration, and performance.

### **2. AI-Accelerated Prototyping**

We will leverage LLMs as a “senior pair programmer” to bridge the gap
between an idea and a working demo.

- **On-the-Fly Demos:** Watch (and participate) as we use LLMs to
  generate boilerplate code and complex UI components in seconds.

- **Rapid Troubleshooting:** See how to use AI to debug integration
  issues and interpret documentation errors in real-time.

### **3. Live Integration**

Bring your own project, data, or dashboard. The goal is to leave the
session with a functional “proof of concept” embedded in your own work.

- **Docs-First Learning:** We will navigate official developer
  documentation together, ensuring you learn how to find answers long
  after the workshop ends.

- **Collaborative Building:** Get hands-on help as you experiment with
  your chosen feature.

### **What You’ll Need**

- **A Project:** An existing dashboard, a dataset, or even just a clear
  idea of a feature you want to build.
